    ...
    setup(props, { emit }) {
        ...
        const loadGridCSS = () => {
            return new Promise((resolve, reject) => {
                if (document.querySelector('link[href*="ag-grid-community"]')) {
                    resolve();
                    return;
                }
        ...
        const initializeGrid = async () => {
            ...
            try {
                await loadGridCSS();
                setGridState({ ...gridState.value, cssLoaded: true });
        ...
        // Handle cell updates with debounce to prevent loops
